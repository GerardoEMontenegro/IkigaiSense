...
urlpatterns = [
    ...
    path('auth/login/', views.UserLoginView.as_view(), name='auth_login'),    # Ruta para el inicio de sesión del usuario
    path('auth/logout/', views.UserLogoutView.as_view(), name='auth_logout'),    # Ruta para el cierre de sesión del usuario
